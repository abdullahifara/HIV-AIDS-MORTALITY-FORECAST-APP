...
with tab4:
    ...
    ax.set_title("Residuals from ARIMA(2,2,3) (1992–2023)")
    ax.set_xlabel("Year")
    ...
    rmse_train = mean_squared_error(aligned_train_actual, model_fit.fittedvalues, squared=False)
    mae_train = mean_absolute_error(aligned_train_actual, model_fit.fittedvalues)
